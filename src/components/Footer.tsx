...
export const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  ...
  return (
    <footer className="bg-white border-t border-[#E4E4E7] text-[#18181B] pt-12 pb-8">
      {/* Newsletter Section */}
      <div className="w-full max-w-[1680px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 mb-12">
      ...
      <div className="w-full max-w-[1680px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-14 border-b border-[#E4E4E7]">
        {/* Brand Column */}
      ...
      <div className="w-full max-w-[1680px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 pt-8 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-[#71717A]">
